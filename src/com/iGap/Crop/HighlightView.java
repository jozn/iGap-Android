...
class HighlightView {
    ...
    private void initStyles(Context context) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(outValue.resourceId, R.styleable.ActionBar);
        try {
            showThirds = attributes.getBoolean(R.styleable.ActionBar_background, false);
            showCircle = attributes.getBoolean(R.styleable.ActionBar_background, false);
            highlightColor = attributes.getColor(R.styleable.ActionBar_background,
                    DEFAULT_HIGHLIGHT_COLOR);
            handleMode = HandleMode.values()[attributes.getInt(R.styleable.ActionBar_background, 0)];
        } finally {
            attributes.recycle();
        }
    }
