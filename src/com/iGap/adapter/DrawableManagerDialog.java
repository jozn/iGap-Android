...
public class DrawableManagerDialog {

    private final Map<String, Bitmap> drawableMap;
    private Handler                   handler = new Handler();


    public DrawableManagerDialog(Context mContext) {
    ...
    public void fetchDrawableOnThread(final String filepath, final ImageSquareProgressBarDialog imageView) {
