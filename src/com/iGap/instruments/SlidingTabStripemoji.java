...
/**
 * 
 * make strip sliding line under emoji tabs
 *
 */

class SlidingTabStripemoji extends LinearLayout {
    ...
    private SlidingTabLayoutemoji.TabColorizer mCustomTabColorizer;
    private final SimpleTabColorizer           mDefaultTabColorizer;


    SlidingTabStripemoji(Context context) {
        this(context, null);
    }


    SlidingTabStripemoji(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    void setCustomTabColorizer(SlidingTabLayoutemoji.TabColorizer customTabColorizer) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final SlidingTabLayoutemoji.TabColorizer tabColorizer = mCustomTabColorizer != null
                ? mCustomTabColorizer
    ...
    private static class SimpleTabColorizer implements SlidingTabLayoutemoji.TabColorizer {
