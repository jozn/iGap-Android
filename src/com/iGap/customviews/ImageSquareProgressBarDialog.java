 ...
 * @since 1.0.0
 */
public class ImageSquareProgressBarDialog extends RelativeLayout {

    private ImageView                imageView;
    private LinearLayout             layout;
    private SquareProgressViewDialog bar;
     ...
     * @since 1.0.0
     */
    public ImageSquareProgressBarDialog(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        LayoutInflater mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mInflater.inflate(R.layout.image_progress_for_dialog, this, true);

        bar = (SquareProgressViewDialog) findViewById(R.id.squareProgressBar1);
     ...
     * @since 1.0.0
     */
    public ImageSquareProgressBarDialog(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mInflater.inflate(R.layout.image_progress_for_dialog, this, true);
        bar = (SquareProgressViewDialog) findViewById(R.id.squareProgressBar1);
     ...
     * @since 1.0.0
     */
    public ImageSquareProgressBarDialog(Context context, String viewKind) {
        super(context);
        LayoutInflater mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mInflater.inflate(R.layout.image_progress_for_dialog, this, true);
