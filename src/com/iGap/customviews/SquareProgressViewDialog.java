 ...
 * 
 * @Use in viewPagers that show images
 *
 */

public class SquareProgressViewDialog extends View {
    ...
    public SquareProgressViewDialog(Context context, View view) {
        super(context);
        initializePaints(context);
    }


    public SquareProgressViewDialog(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initializePaints(context);
    }


    public SquareProgressViewDialog(Context context, AttributeSet attrs) {
        super(context, attrs);
        initializePaints(context);
    }
    ...
    private void initializePaints(Context context) {
        ...
        progressBarPaint.setColor(Color.parseColor("#70707070"));
